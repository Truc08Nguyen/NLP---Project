...
/**
   * Keyword recognition:
   * gets the name of the author through the given user input
   * @param input the users string and find the list of valid author names
   * @return the recognized author name
   */
  public static String getAuthor(String input, ArrayList<String> authors){
